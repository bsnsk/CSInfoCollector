...
os.system('cat src/8-PU/faculty/faculty/spiders/faculty_spider.py ' \
    + ' > src/' + univ_name + '/faculty/faculty/spiders/faculty_spider.py')

os.system('sed -i \'\' \'s/8-PU/'+ univ_name+ '/g\' \
	src/' + univ_name + '/faculty/faculty/spiders/faculty_spider.py')
