...
class FacultySpider(scrapy.Spider):
    ...
    start_urls = [
            "http://www.eecs.berkeley.edu/Faculty/Lists/faculty.shtml"
    ]
    ...
    def person_info_parse(self, response):
        ...
        if filename == "":
            return
        target_filename = "../../../data/1-UCB/" + name.encode('utf-8') + "/" + filename.lstrip('/').encode('utf-8')
    ...
    def person_index_parse(self, response):
        ...
        if name == "":
            return
        filename = "../../../data/1-UCB/" + name.encode('utf-8') + "/index.html"
        print response.url,
        if os.path.isfile(filename):
            ...
            print " ..."
        system('mkdir "../../../data/1-UCB/' + name.encode('utf-8') + '"')
    ...
    def parse(self, response):
        for sel in response.xpath("//table/tr/td/strong"):
