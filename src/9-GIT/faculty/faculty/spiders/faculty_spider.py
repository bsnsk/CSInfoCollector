...
class FacultySpider(scrapy.Spider):
    ...
    for i in range(2, 24):
        start_urls.append("http://www.cc.gatech.edu/people/faculty?title=&page=" + str(i))
    ...
    def person_info_parse(self, response):
        ...
        if filename == "":
            return
        target_filename = "../../../data/9-GIT/" + name.encode('utf-8') + "/" + filename.lstrip('/').encode('utf-8')
    ...
    def person_index_parse(self, response):
        ...
        if name == "":
            return
        filename = "../../../data/9-GIT/" + name.encode('utf-8') + "/index.html"
        print response.url,
        if os.path.isfile(filename):
            ...
            print " ..."
        system('mkdir "../../../data/9-GIT/' + name.encode('utf-8') + '"')
